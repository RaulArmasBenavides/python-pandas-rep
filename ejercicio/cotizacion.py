"""
EEl fichero cotizacion.csv contiene las cotizaciones de las empresas del IBEX35 con las siguientes columnas: 
...
if __name__ == "__main__":
  df = resumen_cotizaciones('ejercicio/cotizacion.csv')
  print(df)
